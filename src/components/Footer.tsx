...
const Footer = () => {
  return (
    <footer className="relative mt-12 border-t border-white/10">
      <div className="absolute inset-x-0 top-0 h-px bg-cyan-500/60" />
      <div className="mx-auto grid max-w-7xl grid-cols-1 gap-8 px-4 py-10 sm:grid-cols-2 sm:gap-10 sm:px-6 sm:py-14 md:grid-cols-4 lg:px-10">
        <div className="col-span-2 md:col-span-1">
          <Link to="/" className="flex items-center gap-2">
            ...
            <span className="font-display text-xl font-bold">Sinema</span>
          </Link>
          ...
          <div className="mt-6 flex gap-2">
            {[Instagram, Twitter, Youtube, Linkedin, Github].map((Icon, i) => (
              <a
                ...
                className="flex h-9 w-9 items-center justify-center rounded-full border border-white/10 bg-white/5 text-muted-foreground transition-all hover:-translate-y-0.5 hover:border-yellow-400/50 hover:text-white"
              >
